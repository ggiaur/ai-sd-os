# AI-SD-OS V6.1.0 — Architektúra Blueprint (Kódmelléklet)

> **Ez a fájl NEM a README.** A `README.md`-ből lett kiszervezve, mert ez a dokumentum egy korábbi tervezési/kódgenerálási munkamenet **referencia-forráskód blueprintje**, nem felhasználói dokumentáció.

**Fontos:** ez a blueprint egy *célállapot-terv* a V6.1.0-hoz, és több ponton eltér a repóban ténylegesen megvalósított kódtól (más osztálynevek, más állapotkezelés stb.) — lásd a dokumentum végén az [Auditálási megjegyzést](#auditálási-megjegyzés-v61-blueprint-vs-tényleges-kód). Éles referenciának a tényleges `kernel/`, `contracts/`, `agents/` stb. forráskódot használd, ne ezt a fájlt.

A rendszer felhasználói dokumentációja: [`README.md`](../README.md).
